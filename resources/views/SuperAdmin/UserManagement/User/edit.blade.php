@extends('layouts.app', ['pagename' => 'Edit User'])
        ...
        <div class="row">
            <div class="col">
                <div class="card shadow-lg mb-5">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('super-admin.user-management.users.update', $user->id) }}">
                            @method('PUT')
                            {{ csrf_field() }}
                            <div class="px-lg-4">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" id="input-role-name" value="{{ $user->name }}"
