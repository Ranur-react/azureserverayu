                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body pt-2">
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush" id="example12">
                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{ route('learning-design.learning-need-analysis.request-syllabuses.index') }}" class="btn btn-icon btn-sm btn-3 btn-primary" type="button">
            ...
            <div class="modal-body">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel"
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="exampleTest">
                                <thead class="thead-light">
                                    <tr>
