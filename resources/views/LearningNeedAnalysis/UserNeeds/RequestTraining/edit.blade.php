...
'Request Training' =>'/learning-need-analysis/user-needs/request-training',
...
@section('content')
                ...
                <div class="card-header position-relative">
                    <div class="row align-items-start">
                        <div class="col-lg-8 col-12">
                            ...
                            @can('training_request_edit')
                                @if ($user_need->status_id == 3)
                                    <div class="row p-3">
                                        <div class="mr-4">
                                            <form method="POST"
                                                action="{{ route('learning-need-analysis.user-needs.request-training.rejectLearningDesign', $user_need->id) }}">
                                                @method('PUT')
                                                {{ csrf_field() }}
                                        ...
                                        <div>
                                            <form method="POST"
                                                action="{{ route('learning-need-analysis.user-needs.request-training.approveLearningDesign', $user_need->id) }}">
                                                @method('PUT')
                                                {{ csrf_field() }}
                            ...
                            @endcan
                            @if ($hcbp_count > 0)
                                @if ($user_need->status_id == 1)
                                <div class="row p-3">
                                    <div class="mr-4">
                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#rejectHcbpModal">
                                            Reject
                                          </button>                                          
                                    </div>
                                    <div>
                                        <form method="POST"
                                            action="{{ route('learning-need-analysis.user-needs.request-training.approveHcbp', $user_need->id) }}">
                                            @method('PUT')
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-success">Approve</button>
                                        </form>
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="training_background" id="textarea-training-background" class="form-control text-black" rows="10" disabled>{{ $user_need->syllabus->training_background }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="training_urgency" id="textarea-training-urgency" class="form-control text-black" rows="10" disabled>{{ $user_need->training_urgency }}</textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="competency_gap" id="input-competency-gap"
                                            value="{{ $string_name }}"
                                            class="form-control form-control-custom bg-white text-black" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="future_plans_after_training" id="textarea-future-plan-after-training" class="form-control text-black" rows="10" disabled>{{ $user_need->training_urgency }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="partner_recommendation" class="form-control text-black" id="select-partner-recommendation" value="{{ $user_need->userNeedVendor->partner_name }}"  disabled>       
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        <label class="form-control-label" for="input-date">Date
                                            ...
                                            <input class="form-control text-black" id="input-date" name="date" 
    ...
    <!-- Modal -->
<div class="modal fade" id="rejectHcbpModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">        
        <form method="post" action="{{ route('learning-need-analysis.user-needs.request-training.rejectHcbp', $user_need->id) }}">
            @method('PUT')
            {{ csrf_field() }}
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Reject User Needs</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <label class="form-control-label" for="textarea-reason">Reason For Rejection <span class="font-italic">(Optional)</span></label>
                        <textarea name="reason_hcbp" class="form-control" id="textarea-reason" rows="3"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <script>
        $('#example').DataTable({
            "pagingType": "numbers",
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('learning-need-analysis.user-needs.request-training.getUserNeedAjaxEmployees', $user_need->id) }}",
                },
                "columns": [
                    {
                        data: 'nik',
