            ...
            <div class="col">
                <div class="card shadow rounded">
                    <div>
                        ...
                        <form method="POST"
                            action="{{ route('learning-design.learning-need-analysis.request-syllabuses.store') }}">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="px-lg-4">
                                    <div class="row">
                                                ...
                                                {{-- <input type="text" name="level" id="input-level"
                                                    ...
                                                    <select name="level[]" id="select-level" class="form-control {{ $errors->has('level') ? ' is-invalid' : '' }}" multiple="multiple" required>
                                                        @foreach ($levels as $level)
                                                            <option value="{{ $level->id }}" @if (old("level")){{ (in_array($level->id, old("level")) ? "selected":"") }} @endif>{{ $level->name }}</option>
                                                        @endforeach
                                                    </select>
                                                @error('level')
                                                    <span class="invalid-feedback" style="display: block;"
                                                    ...
                                                    class="form-control form-control-custom {{ $errors->has('status') ? ' is-invalid' : '' }}">
                                                     ...
                                                     <select name="status[]" id="select-status" class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}" multiple="multiple" required>
                                                        @foreach ($statuses as $status)
                                                            <option value="{{ $status->id }}" @if (old("status")){{ (in_array($status->id, old("status")) ? "selected":"") }} @endif>{{ $status->name }}</option>
                                                        @endforeach
                                                     </select>
                                                @error('status')
                                                    <span class="invalid-feedback" style="display: block;"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-training-background">Training
                                                    Background <span style="color:red">*</label></label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-training-description">Training
                                                    Description <span style="color:red">*</label></label>
                                                <textarea class="form-control" name="training_description"
                                                    id="input-training-description" rows="5"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-learning-scope">Learning
                                                    Scope <span style="color:red">*</label></label>
                                                    <textarea style="display: none" id="learning_scope" name="learning_scope"></textarea>
