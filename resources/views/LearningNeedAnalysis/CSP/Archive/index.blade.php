                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col d-flex justify-content-between">
                                    <h3 class="mb-0">CSP Archive</h3>
                                    <div class="text-right">
                                        @if (auth()->user()->can('csp_edit') || auth()->user()->can('csp_delete'))
                                            @can('csp_edit')
                                                <a href="{{ route('learning-need-analysis.csp.restore.archive') }}"
                                                    id="button_restore" class="btn btn-secondary">Restore</a>
                                            @endcan
                                            @can('csp_delete')
                                                <a href="{{ route('learning-need-analysis.csp.archive.forceDelete') }}"
                                                    id="button_delete" class="btn btn-secondary">Delete</a>
                                            @endcan
                                        @endif
                                        <a href="{{ route('learning-need-analysis.csp.index') }}"
        ...
        <script>
            $(document).ready(function() {
                $("#button_restore").click(function() {
                    ...
                    $("input[name='csp[]']:checked").map(function() {
