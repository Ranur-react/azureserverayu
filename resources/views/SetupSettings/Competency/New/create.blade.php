        ...
        <div class="row">
            <div class="col">
                <div class="card shadow-lg mb-5">
                    ...
                    <div class="card-body">
                        <form method="POST" id="formCreateCompetency" action="{{ route('setup-settings.competencies.store') }}">
                            {{ csrf_field() }}
                            <div class="px-lg-4">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}"
                                                ...
                                                <option value="ROLE COMPETENCY"
                                                    {{ old('type') == 'ROLE COMPETENCY' ? 'selected' : '' }}>Role
                                                    Competency</option>
                                                <option value="BEHAVIOR"
                                                    {{ old('type') == 'BEHAVIOR' ? 'selected' : '' }}>Behavior</option>
                                                <option value="TECHNICAL SKILL"
                                                    {{ old('type') == 'TECHNICAL SKILL' ? 'selected' : '' }}>Technical
                                                    Skill</option>
                                                <option value="KNOWLEDGE"
                                                    {{ old('type') == 'KNOWLEDGE' ? 'selected' : '' }}>Knowledge</option>
                                                <option value="DIGITAL CULTURE"
                                                    {{ old('type') == 'DIGITAL CULTURE' ? 'selected' : '' }}>Digital
                                                    Culture</option>
                                                <option value="TELKOMSEL DIGILIFE"
                                                    {{ old('type') == 'TELKOMSEL DIGILIFE' ? 'selected' : '' }}>Telkomsel
                                                    Digilife</option>
                                            </select>
                                            @error('type')
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea
                                                ...
                                                required>{{ old('definition_english') }}</textarea>
