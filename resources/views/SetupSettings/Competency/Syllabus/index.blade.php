                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col d-flex justify-content-between">
                            <h3 class="mb-0">List Syllabus {{ $prfCompetencyCatalog->name }}</h3>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready( function() {
        ...
        serverSide: true,
        "pagingType": "numbers",
        "ajax": "{{ route('setup-settings.competencies.syllabuses.getAjaxCompetencySyllabuses', $prfCompetencyCatalog->id) }}",
        "columns":[
