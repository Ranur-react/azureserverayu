                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('learning-design.learning-need-analysis.user-needs.requestSyllabus') }}"
                                        ...
                                        <div class="row mt-2 p-2">
                                            <div class="col">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('atasan.learning-need-analysis.carts-user-needs.destroy', $row->rowId) }}"
                                                        class="mb-0">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
