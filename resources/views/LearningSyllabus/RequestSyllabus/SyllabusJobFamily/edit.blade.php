@extends('layouts.app', ['pagedirectory' => ['Request Syllabus' =>'/learning-syllabus/request-syllabus',
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            @can('learning_syllabus_approve')
                                <div class="row p-3">
                                    <div class="mr-4">
                                        <form method="POST"
                                              action="{{ route('learning-syllabus.request-syllabus.job-families.reject', [$syllabus->id, $jobFamily->id]) }}">
                                            @method('PUT')
                                            {{ csrf_field() }}
                                    ...
                                    <div>
                                        <form method="POST"
                                              action="{{ route('learning-syllabus.request-syllabus.job-families.update', [$syllabus->id, $jobFamily->id]) }}">
                                            @method('PUT')
                                            {{ csrf_field() }}
