            ...
            <div class="col">
                <div class="card shadow rounded">
                    <div>
                        ...
                        <form method="POST"
                            action="{{ route('learning-syllabus.job-families.syllabuses.store', $jobFamily->id) }}"
                            ...
                            <div class="card-body">
                                <div class="px-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-job-family-name">Job
                                                    Family Name</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-syllabus-code">Syllabus Code</label>
                                                <input type="text" name="syllabus_code" id="input-syllabus-code"
                                                    value="{{ $jobFamily->job_family_code ?? '' }}.0"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-learning-scope">Learning
                                                    Scope </label>
                                                    <textarea style="display: none" id="learning_scope" name="learning_scope" required>{!! old('learning_scope')  !!}</textarea>
...
@push('js')
    {{-- <script type="text/javascript">
        $(document).ready(function(){
            $("#formJobFamilySyllabus").submit(function() {
