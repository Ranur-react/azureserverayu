            ...
            <div class="col">
                <div class="card shadow rounded">
                    <div>
                        ...
                        <form method="POST"
                            action="{{ route('learning-syllabus.job-families.syllabuses.update', [$jobFamily->id, $syllabus->id]) }}"
                            id="formJobFamilySyllabus">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="card-body">
                                <div class="px-lg-4">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-user-name">Job Family Code</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                <label class="form-control-label" for="input-user-name">Job
                                                    Family Name</label>
                                                <input type="text" name="job_family_name" value="{{ $jobFamily->name }}"
                                                    id="input-job-family-name" class="form-control text-black" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="syllabus_code" id="input-syllabus-code"
                                                    ...
                                                    class="form-control text-black {{ $errors->has('syllabus_code') ? ' is-invalid' : '' }}" disabled>
                                                @error('syllabus_code')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="training_name" id="input-training-name"
                                                    ...
                                                    class="form-control {{ $errors->has('training_name') ? ' is-invalid' : '' }}" required autofocus>
                                                @error('training_name')
                                                    <span class="invalid-feedback" style="display: block;"
                                                        role="alert"><strong>{{ $message }}</strong></span>
                                                @enderror
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea type="text" name="training_summary" id="input-training-summary"
                                                    ...
                                                    style="resize: none;"
                                                    required>{{ old('training_summary', $syllabus->training_summary) }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="training_background"
                                                    ...
                                                    required>{{ old('training_background', $syllabus->training_background) }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="training_description"
                                                    ...
                                                    required>{{ old('training_description', $syllabus->training_description) }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea style="display: none" id="learning_scope"
                                                    name="learning_scope">{!! $syllabus->learning_scope !!}</textarea>
    ...
    <script>
        $( document ).ready(function() {
            $('#select-partner-recommendation').select2({
                ...
                allowClear: true,
                ajax: {
                    url: "{{ route('learning-syllabus.job-families.syllabuses.getSelect2VendorsAjax', $jobFamily->id) }}",
                    dataType: 'json',
                    delay: 250,
                    data: function(params) {
                        return {
        ...
        var tagify = new Tagify(inputElm, {
            ...
            whitelist: [
                @foreach ($competencies as $competency)
                    {
                        "value" :{{ $competency->id }},
                        "name" :"{!! addcslashes($competency->name, "'") !!}",
                    },
                @endforeach
            ],
            dropdown: {
