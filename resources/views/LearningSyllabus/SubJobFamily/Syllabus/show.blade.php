...
$subJobFamily->name => '/learning-design/learning-syllabus/job-families/' . $jobFamily->id . '/sub-job-families/' .
                    ...
                    <div class="p-md-3 p-1">
                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="col-lg-6 d-none d-md-block col-lg-2">
                                                ...
                                                <div class="row justify-content-end mt-3">
                                                    @can('learning_syllabus_edit')
                                                        <form method="post"
                                                            action="{{ route('learning-design.learning-syllabus.job-families.sub-job-families.syllabuses.deactivate', [$jobFamily->id, $subJobFamily->id, $syllabus->id]) }}">
                                                            @method('PUT')
                                                            {{ csrf_field() }}
                                        ...
                                        @if ($syllabus->is_approved == 1 && $syllabus->is_active == 0)
                                            <div class="col-lg-6 d-none d-md-block col-lg-2">
                                                ...
                                                @can('learning_syllabus_edit')
                                                    <div class="row justify-content-end mt-3">
                                                        <form method="post"
                                                            action="{{ route('learning-design.learning-syllabus.job-families.sub-job-families.syllabuses.activate', [$jobFamily->id, $subJobFamily->id, $syllabus->id]) }}">
                                                            @method('PUT')
                                                            {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel"
                                ...
                                <div class="card-header pb-2">
                                    <h3 class="text-xl font-weight-extrabold">Export Log</h3>
                                </div>
                                <!-- Light table -->
