                            ...
                            @can('learning_syllabus_edit')
                                @if ($syllabus->status_id == 1)
                                    <form method="post" id="formDeactivateSyllabus"
                                          action="{{ route('learning-syllabus.job-families.sub-job-families.syllabuses.deactivate', [$jobFamily->id, $subJobFamily->id, $syllabus->id]) }}">
                                        @method('PUT')
                                        {{ csrf_field() }}
                            ...
                            @can('learning_syllabus_edit')
                                @if ($syllabus->status_id == 2)
                                    <form method="post" id="formActivateSyllabus"
                                          action="{{ route('learning-syllabus.job-families.sub-job-families.syllabuses.activate', [$jobFamily->id,  $subJobFamily->id, $syllabus->id]) }}">
                                        @method('PUT')
                                        {{ csrf_field() }}
