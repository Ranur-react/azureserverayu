                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col d-flex justify-content-between">
                            <h3 class="mb-0">List Syllabus</h3>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready( function() {
        ...
        serverSide: true,
        "pagingType": "numbers",
        "ajax": "{{ route('master-data.statuses.syllabuses.getAjaxStatusSyllabuses', $status->id) }}",
        "columns":[
            { data: 'syllabus_code', name: 'syllabus_code' },
            { data: 'training_name', name: 'training_name'  },
            { data: 'syllabus_status_name', name: 'syllabuses_statuses.id'},
            ]
        });
