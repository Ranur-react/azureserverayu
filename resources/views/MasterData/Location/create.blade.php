                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="description" id="input-description" value="{{ old('description') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" maxlength="4" name="town_or_city" id="input-town-or-city" value="{{ old('town_or_city') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" maxlength="10" name="postal_code" id="input-postal-code" value="{{ old('postal_code') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="region_1" id="input-region-1" value="{{ old('region_1') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" maxlength="32" name="admins" id="input-admins" value="{{ old('admins') }}"
