            ...
            <div class="card shadow-lg mb-5">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Edit Units</h3>
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('master-data.organization-units.update', $organizationUnit->organization_id ) }}"
                        id="formUnit">
                        @method('PUT')
                        {{ csrf_field() }}
                        <div class="px-lg-4">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        {{ $errors->has('location_id') ? ' is-invalid' : '' }}">
                                            <option value="{{ $organizationUnit->location_id }}" selected>{{ $organizationUnit->location->location_code ?? '' }}</option>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="date_from" id="input-date-from" value="{{ old('date_from', $organizationUnit->date_from) }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="date_to" id="input-date-to" value="{{ old('date_to', $organizationUnit->date_to) }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="type" id="input-type"
                                            value="{{ old('type', $organizationUnit->type) }}"
