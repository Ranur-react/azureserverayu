...
class PrfCompetencyCatalogTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('prf_competency_catalog')->delete();
        
        \DB::table('prf_competency_catalog')->insert(array (
            0 => 
            array (
                'id' => 1,
                'name' => 'Adaptability',
                'type' => 'ROLE COMPETENCY',
            'definition' => 'Kemampuan memodifikasi/mengubah perilaku untuk menyesuaikan diri dengan kondisi maupun situasi tertentu (dapat berupa situasi baru, perubahan lingkungan, kejadian insidental, krisis, kondisi ambigu/tidak pasti, termasuk menghadapi perbedaan antar individu).
...
Kompetensi ini memungkinkan seseorang untuk merespons secara efektif berbagai tuntutan situasi, menunjukkan sikap positif terhadap perubahan dan ambiguitas/ketidakpastian, serta reseptif dalam melakukan penyesuaian yang diperlukan.',
            ...
            array (
                ...
                'name' => 'Anticipatory',
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan untuk memprediksi berbagai kemungkinan yang terjadi untuk menghadapi ketidakpastian situasi di masa depan. 
Penguasaan kompetensi ini ditunjukkan dengan kemampuan membayangkan gambaran masa depan dan berpikir sistematis untuk merencanakan cara yang realistis dan berkelanjutan untuk menghadapi kompleksitas di masa depan, serta menyusun tindakan preventif untuk mengatasi rintangan maupun menghindari kegagalan.
Seseorang dengan kemampuan antisipatif akan mampu melihat dan memanfaatkan peluang masa depan serta mengelola potensi risiko di masa depan dengan cara yang tepat.',
            ...
            array (
                ...
                'name' => 'Collaboration',
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan bekerja sama untuk mencapai tujuan dengan mempertimbangkan kapabilitas dan kapasitas setiap orang. 
Penguasaan kompetensi ini ditunjukkan dengan kemampuan membangun hubungan kohesif dengan pihak-pihak terkait untuk mencapai hasil tertentu.',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan untuk mengidentifikasi pola atau hubungan dari dua atau lebih situasi yang belum jelas keterkaitannya, serta mengidentifikasi pokok permasalahan dari situasi yang kompleks.
Berpikir konseptual juga mencakup proses mengintegrasikan masalah dan faktor-faktor tertentu ke dalam suatu model, teori maupun kerangka berpikir untuk memahami dan menjelaskan permasalahan bisnis, komersial, masalah ilmiah, peristiwa maupun situasi spesifik. 
Kemampuan ini melibatkan penalaran induktif (yakni penarikan kesimpulan dari informasi yang beragam dan kurang lengkap menjadi pemahaman yang jelas) maupun pemikiran abstrak (yakni kemampuan untuk memahami suatu ide tanpa adanya hal-hal yang bersifat konkret)',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan mengarahkan tindakan untuk mencapai tujuan secara efektif, efisien dan berkelanjutan. 
Penguasaan  kompetensi ini ditunjukkan dengan kemampuan dalam mengidentifikasi dan mengelola sumber daya (tenaga, materi, informasi, waktu) secara efektif, efisien dan berkelanjutan agar tetap kompetitif dalam bisnis. 
Individu dengan kemampuan ini cenderung efektif & efisien dalam mengelola sumber daya (baik finansial maupun non finansial), melalui pengukuran, perencanaan spesifik dan pengendalian sumber daya serta melakukan beberapa proses penyesuaian untuk memaksimalkan hasil yang dicapai.',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan melakukan upaya berkelanjutan untuk mencapai kualitas standar penyelesaian pekerjaan, dengan meminimalisasi kesalahan, ketidaksesuaian dan ketidakpastian di lingkungan kerja sesuai dengan standar, aturan, serta prosedur yang berlaku. 
Penguasaan kompetensi ini ditunjukkan melalui perilaku memantau & memeriksa pekerjaan atau informasi, melakukan validasi data, memastikan kejelasan peran dan keteraturan, serta menuntut kepatuhan terhadap standar tertentu.',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan menyelesaikan konflik/perselisihan yang terjadi antar individu atau kelompok/tim yang memiliki kepentingan, kebutuhan, dan tujuan berbeda. 
Penguasaan kompetensi ini ditunjukkan dengan kapabilitas mengatasi permasalahan dengan berfokus pada sumber masalah dan mengembangkan solusi secara efektif, efisien serta adil melalui proses negosiasi untuk mendapatkan kesepakatan dan mitigasi terjadinya konflik.
',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan melakukan upaya berkelanjutan untuk meningkatkan praktik, metode, prosedur, maupun sistem yang ada saat ini dengan menerapkan pendekatan sistematis serta langkah terstruktur guna meningkatkan proses dan kualitas. 
Proses pengembangan berkelanjutan dapat dilakukan dengan menggunakan pendekatan atau ide baru, adopsi ide dari best practices, maupun penerapan sistem kendali mutu dan perbaikan struktural.',
            ...
            array (
                ...
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan melihat situasi dari sudut pandang pelanggan dalam merencanakan, merancang dan memberikan layanan atau solusi untuk memenuhi harapan/kepuasan pelanggan berdasarkan masukan dan keluhan pelanggan.
"Pelanggan" dapat didefinisikan secara luas, termasuk end-customer, distributor, "pelanggan" internal, maupun mitra',
            ...
            array (
                ...
                'name' => 'Data Driven',
                'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan menggunakan data sebagai dasar proses analisa dan penyelesaian masalah. 
Kompetensi ini secara konsisten menggunakan data sebagai sumber rujukan untuk menunjukkan pentingnya pemahaman data dalam mendukung proses pekerjaan, pengelolaan data secara efisien, pemanfaatan data guna menghasilkan dampak serta menghasilkan analisa yang lebih tajam.',
            ...
            array (
                ...
                'name' => 'Decisiveness',
                'type' => 'ROLE COMPETENCY',
            'definition' => 'Kemampuan mengambil keputusan secara akurat, efektif dan tepat waktu, walaupun saat dihadapkan pada situasi yang ambigu (multitafsir) atau memiliki potensi konflik.
(Penguasaan terhadap kompetensi ini mensyaratkan penilaian yang baik terhadap situasi, dengan melakukan analisis terhadap informasi yang akurat dan relevan, mengidentifikasi inti permasalahan, mempertimbangkan berbagai kemungkinan dan tindakan yang dapat dilakukan serta memahami dampak/implikasi dari keputusan yang diambil.',
                ...
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan dalam memfasilitasi/mendukung proses pembelajaran dan pengembangan orang lain dengan mengoptimalkan kelebihan yang dimiliki dan mengatasi kekurangannya untuk meningkatkan kinerja serta memenuhi kebutuhan kompetensi organisasi.
Proses pengembangan dapat dilakukan melalui pemberian umpan balik konstruktif, pembinaan (coaching), penetapan target pengembangan individu, memonitor kemajuan, mengelola masalah kinerja, menyusun rencana pengembangan jangka panjang, serta memberikan tugas yang menantang sesuai kapabilitasnya.
Penekanan pada kompetensi ini adalah pada intensi yang ditunjukkan untuk mengembangkan orang lain, bukan sekedar memberi kesempatan untuk mengikuti suatu pelatihan.',
                ...
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                'definition' => 'Kemampuan membangun, menjaga dan memperkuat hubungan dengan pemangku kepentingan (stakeholders) serta melibatkannya ke dalam strategi/arah bisnis perusahaan guna meningkatkan kinerja dan kemampuan sehingga tercapai tujuan.
Pemangku kepentingan secara luas diartikan sebagai komunitas masyarakat dan pihak-pihak tertentu yang dapat mempengaruhi maupun memperoleh dampak tertentu dari kegiatan perusahaan mencakup di dalamnya pelanggan, klien, karyawan, pemasok, mitra bisnis, investor, pemerintah pusat/daerah, regulator, kelompok atau forum komunitas, dan LSM.',
...
Penekanan pada kompetensi ini  adalah pada variasi dan kompleksitas cara yang dilakukan untuk memengaruhi orang lain secara efektif.',
                ...
                array (
                    ...
                    'name' => 'Initiative',
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengidentifikasi masalah, hambatan atau peluang dan sigap mengambil tindakan untuk mengatasi masalah ataupun memanfaatkan peluang sebelum orang lain bertindak. 
Penekanannya adalah pada kemampuan mengatasi  masalah yang dihadapai secara proaktif dan terus menerus serta memanfaatkan secara optimal setiap peluang yang muncul sebelum orang lain. 
Skala perilaku dalam kompetensi ini dimulai dari kesigapan dalam menyelesaikan masalah/memanfaatkan peluang yang muncul saat ini, hingga kemampuan mencegah masalah/memanfaatkan peluang yang akan muncul di masa depan. ',
                ...
                array (
                    ...
                    'name' => 'Innovation',
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengembangkan cara-cara kreatif dengan menerapkan ide/cara/metode baru untuk memecahkan masalah atau meningkatkan kinerja. 
Kompetensi ini menerapkan kreativitas dan kecenderungan berpikir “outside the box”, memberikan solusi baru untuk memenuhi kebutuhan saat ini dan masa depan dengan mempertimbangkan potensi risiko yang muncul di unit/organisasi. 
...
Perilaku yang ditampilkan termasuk upaya memahami situasi secara menyeluruh, menggali informasi secara detail, mengajukan pertanyaan menyelidik dan tidak umum  dalam suatu pekerjaan, tren, perkembangan dalam industri, politik, ekonomi, dan lainnya.',
                    'definition_english' => 'Kompetensi ini berkembang seiring dengan intensitas upaya yang dilakukan untuk mengumpulkan informasi',
                    'status' => 1,
                ),
                18 => 
                array (
...
Penguasaan terhadap kompetensi ini ditunjukkan dengan kemampuan untuk mengenali kebutuhan akan perubahan, proaktif menginisiasi perubahan, menyiapkan sumber daya yang diperlukan, mengembangkan program perubahan, mengembangkan sikap, keterampilan, dan perilaku tim yang diperlukan untuk menghasilkan program, layanan, output, mengatasi hambatan yang kompleks dan strategi baru yang dapat mengantisipasi kebutuhan saat ini dan di masa depan, serta menjadikan organisasi tetap kompetitif.',
                    'definition_english' => 'Kompetensi ini berkembang seiring dengan tingkat keterlibatan dalam proses perubahan dan besarnya dampak yang diberikan terhadap perubahan organisasi.',
                    'status' => 1,
                ),
                19 => 
                array (
                    ...
                    'name' => 'Leading Team',
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengambil peran sebagai pemimpin tim atau kelompok, baik secara formal maupun informal dalam organisasi untuk mencapai tujuan bersama. 
Peran kepemimpinan yang dilakukan termasuk mengomunikasikan tujuan dan sasaran kelompok, mengelola kebutuhan kelompok, memberi dukungan terhadap anggota kelompok dan menciptakan situasi yang kondusif untuk mendukung kinerja kelompok. ',
                    'definition_english' => 'Kompetensi ini berkembang dari keutuhan kualitas asumsi peran pemimpin',
                    'status' => 1,
                ),
                20 => 
                array (
                ...
                'definition' => 'Kemampuan mengenali dan mengelola jaringan relasi yang produktif, untuk memberi nilai tambah terhadap bisnis dan menyelesaikan pekerjaan; Individu dengan kompetensi ini akan berupaya melakukan berbagai cara untuk membangun, memelihara, dan memanfaatkan hubungan timbal balik yang saling menghormati, positif dan professional dengan jaringan orang-orang di luar fungsi kerjanya (dan juga di luar organisasi) dan memanfaatkan hubungan tersebut untuk kepentingan organisasi.   ',
                    'definition_english' => 'Kompetensi ini berkembang seiring dengan besarnya hasil atau manfaat yang diperoleh dari jaringan relasi yang dibangun. ',
                    'status' => 1,
                ),
                22 => 
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengelola kinerja orang lain/tim sesuai dengan standar yang diharapkan. 
Penguasaan kompetensi ini ditunjukkan melalui kemampuan memberikan arahan, memastikan pencapaian target, mendorong pencapaian melebihi target, mempertahankan kinerja yang tinggi dan mendorong kinerja tinggi yang berkelanjutan.',
...
Perilaku yang ditampilkan termasuk kemampuan untuk berpikir ke depan dan mengidentifikasi kemungkinan  hambatan atau masalah yang dapat mempengaruhi penyelesaian pekerjaan, menetapkan tugas dan tahapan pekerjaan untuk mencapai suatu target pekerjaan, memantau kemajuan pekerjaan dan membuat penyesuaian bila diperlukan, serta memastikan penggunaan sumber daya yang optimal untuk mencapai tujuan.',
                ...
                array (
                    ...
                    'name' => 'Solutioning',
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengidentifikasi dan menganalisa masalah dengan mempertimbangkan informasi yang relevan dan akurat untuk mendapatkan solusi yang tepat. 
Kemampuan ini dapat melibatkan beberapa kegiatan seperti penilaian situasi, analisa terhadap data dari berbagai sumber yang berbeda, menentukan akar penyebab masalah, serta mengidentifikasi, memprioritaskan dan memilih alternatif untuk solusi penyelesaiannya.',
                ...
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengadopsi teknologi untuk diterapkan pada setiap aspek pekerjaan dan terus memperbarui pengetahuan dengan perkembangan teknologi. 
Individu dengan kompetensi ini cenderung memiliki wawasan yang baik terhadap perkembangan teknologi beserta dampaknya terhadap perkembangan bisnis dan mampu memanfaatkan teknologi secara efektif untuk menunjang kinerja bisnis/organisasi.
Teknologi memiliki pengaruh yang besar bagi strategi perusahaan dan memiliki dampak luas terhadap setiap proses kerja. Organisasi dengan pemimpin yang paham teknologi akan menjadi lebih kompetitif. Seiring dengan dunia yang semakin digital, kecakapan teknologi telah menjadi persyaratan untuk hampir semua jenis pekerjaan',
                ...
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan menerjemahkan visi dan konsep jangka panjang organisasi ke dalam strategi dan prioritas organisasi berdasarkan tren bisnis, kemajuan teknologi, perkembangan kebutuhan pelanggan dan faktor lain yang memiliki dampak terhadap organisasi.
Individu dengan kompetensi ini cenderung mampu mengenali peluang penerapan ide-ide inovatif sesuai dengan kemampuan, sifat, dan potensi organisasi, serta mengambil risiko yang terukur berdasarkan kesadaran akan isu sosial, ekonomi, pasar dan politik, serta tren dan dampaknya terhadap organisasi, pemangku kepentingan dan publik.',
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam merumuskan ide/konsep produk (e.g., legacy product, dll.) yang menarik, kreatif, namun feasible, melakukan review, penerjemahan, serta simulasi terhadap ide/konsep desain tersebut, hingga menjadi suatu prototipe (dengan mempertimbangkan bentuk & fitur desain produk), menyusun roadmap pengembangan prototipe itu sendiri, termasuk penyusunan rencana monetisasi, dll., dengan membandingkan desain produk pesaing & preferensi target audiens, serta mengevaluasi nilai komersial dari desain produk tersebut berdasarkan pada prinsip-prinsip & teknik pengembangan desain produk',
                    'definition_english' => '',
                    'status' => 1,
                ),
                49 => 
                array (
                    'id' => 56,
                    'name' => 'Digital Product Design & Prototyping',
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam merumuskan ide/konsep desain produk digital (e.g., produk video, audio, games, dll.) yang menarik, kreatif, namun feasible, melakukan review, penerjemahan, serta simulasi terhadap ide/konsep desain tersebut, hingga menjadi suatu prototipe (e.g., Low-Fidelity Prototyping, High-Fidelity Prototyping -- alpha/beta release, MVP, dll.), dengan mempertimbangkan bentuk & fitur desain produk, menyusun roadmap pengembangan prototipe itu sendiri, termasuk penyusunan rencana monetisasi, dll., dengan mempertimbangkan user experience, membandingkan desain produk digital pesaing & preferensi target audiens, serta mengevaluasi nilai komersial dari desain produk digital tersebut berdasarkan pada prinsip-prinsip & teknik pengembangan desain produk digital',
                    'definition_english' => '',
                    'status' => 1,
                ),
                50 => 
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam mengkonseptualisasikan & merancang interaction design product/services yang presisi, nyaman, serta mudah digunakan, melalui proses integrasi terhadap information architecture, visual interface design, maupun elemen lainnya dengan bantuan tools terkait (e.g., Hotjar, Optimizely, Usabilla, dll.) serta berdasarkan pada user-centered design principles, sehingga mendukung terciptanya pengalaman positif pelanggan terhadap product/services Telkomsel',
                'definition_english' => 'Knowledge and ability to conceptualize & create product/service interaction design that precise, convenient, and easy to use, through integrate information architecture, visual interface design, and another elements by using certain tools (e.g., Hotjar, Optimizely, Usabilla, etc.), based on user-centered design principles, in order to create positive customer experiences on Telkomsel products/services',
                    'status' => 1,
                ),
                64 => 
                array (
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menentukan tujuan, target segmen, metode pemasaran, termasuk menentukan positioning product/services (value proposition), baik untuk segmen enterprise (e.g., sejauh mana impact dari product/services Telkomsel terhadap perusahaan klien) maupun consumer (e.g., sejauh mana product/services Telkomsel mampu memenuhi keinginan, harapan, serta persepsi konsumen), berdasarkan pada pertimbangan terhadap rencana pemasaran para kompetitor dan hasil analisis kecenderungan tren pasar',
                'definition_english' => 'Knowledge and ability to set marketing objectives, target segments, method, incl. determine product/service positioning (value proposition), either for enterprise segment (e.g., to what extent the impacts of product/service Telkomsel to the clients) or consumer (e.g., to what extent Telkomsel\'s products/services are able to fulfill consumer needs, expectations, and perceptions) based on consideration of competitors\' marketing plans and  market trends analysis results',
                    'status' => 1,
                ),
                71 => 
                array (
                    ...
                    'name' => 'Brand Strategy',
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menciptakan brand profile bagi product/services (e.g., logo, key brand messaging, dll.) serta merancang strategi peningkatan nilai dari brand tersebut di mata konsumen berdasarkan prinsip-prinsip pengelolaan brand product/services secara efektif, dengan menggunakan teknik/metode tertentu (e.g., Name Brand Recognition, Crowdsourcing, etc.)',
                'definition_english' => 'Knowledge and ability to create products/service brand profile (e.g., logo, key brand messaging, etc.) as well as formulate brand value improvement strategy to consumers, based on managing effective product/services brand, by using certain methods/techniques (e.g., Name Brand Recognition, Crowdsourcing, etc.)',
                    'status' => 1,
                ),
                72 => 
                array (
                ...
                'definition_english' => 'Knowledge and ability to formulate product/service brand value improvement strategy to consumers by utilizing digital platforms/internet media (e.g., social media, etc.) or any tools that offered on the internet, based on managing effective product/services brand through digital platforms',
                    'status' => 1,
                ),
                73 => 
                array (
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menentukan tujuan, target, sasaran, jadwal, serta ruang lingkup program promosi & kampanye (marketing communication), melakukan implementasi (melalui media press releases, web sites, public relations events, dll.), hingga melaksanakan evaluasi efektivitas program berdasarkan pada prinsip-prinsip komunikasi marketing serta selaras dengan products/services brand strategy',
                'definition_english' => 'Knowledge and ability to determine goals, targets, objectives, schedules, and scopes of promotional & campaign (marketing communication) program, implement it (through press releases, web sites, public relation events, etc.), up to evaluate program effectiveness based on principles related to marketing communication and align with product/service brand strategy',
                    'status' => 1,
                ),
                75 => 
                array (
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam mengirimkan pesan komersial (e.g., promo, penawaran produk, dll.) dengan memanfaatkan layanan/fitur dari perangkat seluler (e.g., tablet, smartphone) & jaringan, seperti e-mail, SMS, MMS, mobile apps via push notification, dll., termasuk location based services, berdasarkan pada prinsip & aturan pemasaran berbasis perangkat seluler yang berlaku, sehingga menjamin kecepatan dan kemutakhiran informasi pemasaran diterima oleh calon pelanggan',
                'definition_english' => 'Knowledge and ability to send commercial information (e.g., promos, product offerings, etc.) by utilizing features of mobile devices (e.g., tablets, smartphones) & network services, such as e-mail, SMS, MMS, mobile applications via push notification, etc., incl. location based services, based on principles & rules of mobile-based marketing that apply, to ensure accuracy & updated marketing information that received by prospective customers',
                    'status' => 1,
                ),
                79 => 
                array (
                ...
                'definition_english' => 'Knowledge and ability to determine the best digital channel and advertise product/services through internet (e.g., DisplayAds, Pop-up Ads, etc.), as a media to perform marketing (e.g., provide information related to promos, product offers, etc.) ',
                    'status' => 1,
                ),
                80 => 
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menyusun strategi, menetapkan target penjualan (untuk segmen consumer) dan/atau target pengembangan/pembinaan hubungan bisnis (win or retain—untuk segmen enterprise), termasuk melakukan cascading & adjustment terhadap strategi dan target tersebut (jika diperlukan), sehingga selaras & mampu mendukung pencapaian strategi serta tujuan bisnis perusahaan',
                'definition_english' => 'Knowledge and ability to design strategies, set sales targets (for the consumer segment), and/or target related to develop/maintain business relationship (win or retain—for enterprise segment), incl. cascade & adjust the strategies or targets (if needed), in order to support corporate strategy & goals',
                    'status' => 1,
                ),
                81 => 
                array (
                ...
                array (
                    'id' => 93,
                    'name' => 'Services Design & Prototyping',
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam merumuskan ide/konsep desain services (e.g., IoT, Advertising, Data Solution, Cloud, dll.) yang menarik, kreatif, namun feasible, melakukan review, penerjemahan, serta simulasi terhadap ide/konsep desain tersebut, hingga menjadi suatu prototipe (dengan mempertimbangkan bentuk & fitur desain produk, e.g., Low-Fidelity Prototyping, High-Fidelity Prototyping, dll.), menyusun roadmap pengembangan prototipe itu sendiri, termasuk penyusunan rencana monetisasi, dll., dengan membandingkan desain services pesaing, preferensi target audiens & pengalaman pelanggan, serta mengevaluasi nilai komersial dari desain services tersebut berdasarkan pada prinsip-prinsip & teknik pengembangan pengembangan desain service, serta interaksi manusia dengan computer/mesin (devices)',
                    'definition_english' => '',
                    'status' => 1,
                ),
                87 => 
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam memahami serta menganalisis informasi terkait perilaku pelanggan di berbagai touch point (didapat melalui assessment, survei, wawancara, monitoring, dll.), guna menghasilkan rekomendasi peningkatan performansi layanan perusahaan',
                'definition_english' => 'Knowledge and ability to understand and analyze information related to customer behavior in each touch points (that obtained through assessment, survey, interview, monitoring process, etc.), in order to provide recommendation to service improvement',
                    'status' => 1,
                ),
                90 => 
                array (
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam merumusakan desain rancang bangun IT perusahaan, meliputi proses mengoperasionalkan rencana strategis perusahaan, merencanakan, dan/atau mengembangkan struktur serta model bisnis IT, berdasarkan pada prinsip-prinsip, metode, standar, pedoman, maupun framework penyusunan yang berlaku (e.g., Cobit, ITIL, TOGAF, APQC, dll.), dengan mempertimbangkan prioritas tren pasar, hasil evaluasi alternatif strategi, maupun hasil analisis terhadap teknologi perusahaan eksisting, guna mendukung terpenuhinya kebutuhan teknologi informasi perusahaan di masa akan datang
',
                    'definition_english' => '',
                    'status' => 1,
                ),
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam merumuskan ide, hingga merancang konsep aplikasi/software untuk mobile apps, web software, dll., berdasarkan pada prinsip-prinsip pengembangan desain aplikasi/software yang aman & efektif, dengan mempertimbangkan dampak dari desain tersebut (baik terhadap cost maupun faktor-faktor terdampak lainnya) serta melihat keselarasannya dengan requirement document yang tersedia',
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam melakukan penyediaan, konfigurasi, serta instalasi terhadap komponen-komponen perangkat lunak (software infrastructure) yang dibutuhkan perusahaan, termasuk melaksanakan tes/mencopot pemasangan komponen-komponen tertentu, untuk memastikan infrastruktur tersebut dapat digunakan & berfungsi  dengan baik',
                ...
                'definition_english' => 'Knowledge and ability to provide, configure & set up any multimedia infrastructures (e.g., audio video conference, audio visual system, etc)  that are needed by organization, incl. perform tests/deactivations on certain components, to ensure infrastructure usability & functionality',
                    'status' => 1,
                ),
                116 => 
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam mempersiapkan, melakukan pengaturan, monitoring/inspeksi secara rutin, mengoperasikan perangkat data centre (e.g., AC/DC, generator, kabel, dll.), hingga menindaklanjuti perihal terkait data centre resources & facilities (e.g., pengaturan energi, alokasi daya, lingkungan sekitar data centre, dll.) sesuai dengan standar fasilitas/perangkat data centre (termasuk resources terkaitnya), guna mendukung kelancaran dan stabilitas operasional data centre di perusahaan
',
                'definition_english' => 'Knowledge and ability to set up, monitor, up to follow up any cases related to data centre resources & facilities (e.g., energy management, power supply allocation, data centre’s surroundings, etc.), in accordance with data centre standard systems/facilities (incl. another relevant resources), to ensure data centre works smoothly and stable in the organization',
                    'status' => 1,
                ),
                117 => 
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                    'definition' => 'Pengetahuan dan kemampuan dalam menyusun petunjuk teknis operasional, melakukan monitoring, hingga pemeliharaan terhadap perangkat & sistem teknologi informasi, termasuk bagian-bagian kritikal pada perangkat IT di perusahaan, guna memastikan efektivitas, keandalan, serta stabilitas operasional IT di perusahaan',
                    'definition_english' => 'Knowledge and ability to perform monitoring as well as maintenance on information technology devices & systems, incl. IT critical components & systems, to ensure its effectivity, reliability and stability of IT operations in the organization',
                    'status' => 1,
                ),
                118 => 
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menerima, menyediakan, hingga mengevaluasi pemberian layanan/dukungan teknis level nol dan pertama (zero dan first line problems or defect handling) sesuai dengan Service Level Agreement dalam memenuhi kebutuhan user (user’s needs) sebagai pengguna dari layanan IT (customer/end user)
',
                    'definition_english' => '',
                    'status' => 1,
                ),
                ...
                array (
                    ...
                    'definition_english' => 'Knowledge and ability to identify problem’s cycles, perform root cause analysis, identify any possible solutions to problems, handle and solve IT problems, as well as its documentation in accordance with principles & processes of IT problems handling, in order to prevent recurring incidents',
                    'status' => 1,
                ),
                120 => 
                array (
                    ...
                    'definition_english' => 'Knowledge and ability to formulate IT quality standards, monitor, and evaluate the its implementation, incl. ensure organization\'s compliance to IT quality standards, in order to provide IT services that are well quality, reliable, effective, efficient & standardized',
                    'status' => 1,
                ),
                121 => 
                array (
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                    'definition' => 'Pengetahuan dan kemampuan dalam menentukan parameter alarm sesuai dengan tipe, karakteristik, prosedur penanganan & standar kualitas operasional IT & jaringan yang telah ditetapkan, memastikan keberfungsian alarm, melakukan diagnosis, deteksi, serta memberikan respon ketika alarm teraktivasi, termasuk melaporkan detail alarm tersebut, jika membutuhkan proses eskalasi untuk menanganinya',
                    'definition_english' => '',
                    'status' => 1,
                ),
                164 => 
                ...
                array (
                    'id' => 279,
                    'name' => 'Product/Services Knowledge',
                    'type' => 'KNOWLEDGE',
                ...
                array (
                    ...
                    'definition' => '- Berpikir dan melakukan sesuatu dengan cara berbeda diluar ide-ide yang sudah ada
- Menemukan gagasan baru yang lebih bermanfaat',
                ...
                array (
                    ...
                    'name' => 'AGILITY',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Fleksibel
- Kecepatan dalam merespon
- Kecepatan dalam beradaptasi',
                    'definition_english' => NULL,
                    'status' => NULL,
                ),
                316 => 
                array (
                    ...
                    'name' => 'EXPERIMENTAL',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Mencoba sesuatu yang baru berdasarkan persoalan konsumen
...
- Berani menghadapi kegagalan',
                ...
                array (
                    ...
                    'name' => 'OPEN MIND',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Kesadaran dan sikap membuka diri terhadap ide/konsep baru
- Aktif mencari informasi trend teknologi terbaru
- Terbuka terhadap kritik',
                ...
                array (
                    ...
                    'name' => 'ANTICIPATORY',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Mempunyai kepekaan terhadap resiko yang akan terjadi
- Selalu mempunyai alternatif solusi
- Menggunakan data dan pengalaman untuk memprediksi perubahan yang akan datang',
                    'definition_english' => NULL,
                    'status' => NULL,
                ),
                319 => 
                array (
                    ...
                    'name' => 'INNOVATION',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Menerapkan ide baru untuk menghasilkan nilai tambah bagi perusahaan
- Mengimplementasikan karya baru (hasil penerapan ide baru) di waktu dan kesempatan yang tepat untuk menghasilkan keunggulan kompetitif baru',
                    'definition_english' => NULL,
                    'status' => NULL,
                ),
                320 => 
                array (
                    ...
                    'name' => 'NETWORKING',
                    'type' => 'DIGITAL CULTURE',
                    'definition' => '- Membangun hubungan dengan seluruh stakeholder
- Menjaga hubungan untuk menciptakan nilai tambah bagi perusahaan',
                    'definition_english' => NULL,
                    'status' => NULL,
                ),
                321 => 
                ...
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan dalam memahami bisnis, yang ditunjukkan melalui kepekaan terhadap bisnis dan kemampuan melihat situasi atau masalah dari sudut pandang bisnis. 
Penguasaan kompetensi ini ditunjukkan dengan kemampuan untuk memahami implikasi bisnis dari suatu peluang dan keputusan, berdasarkan pada pemahaman akan sistem dan target pencapaian organisasi, serta menerapkan strategi bisnis yang terbukti  mampu meningkatkan kinerja organisasi. Kompetensi ini membutuhkan kemampuan dalam melihat keterkaitan antara suatu isu/permasalahan, proses, hasil dan dampaknya pada pencapaian target organisasi.
Kompetensi ini memengaruhi ketajaman dan kecepatan seseorang dalam memahami serta menanggapi "situasi bisnis."',
                    'definition_english' => 'Kompetensi ini berkembang seiring dengan kedalaman pemahaman individu terhadap bisnis perusahaan.',
                    'status' => 1,
                ),
                324 => 
                array (
                    ...
                    'type' => 'ROLE COMPETENCY',
                    'definition' => 'Kemampuan mengembangkan diri terhadap pengetahuan dan keterampilan serta keahlian yang dibutuhkan, melalui proses  pembelajaran dan pengalaman dengan menerapkanya ke dalam pekerjaan untuk meningkatkan kapasitas dan kapabilitas diri. 
Individu dengan kompetensi ini selalu menilai tingkat perkembangan atau keahlian diri terutama terkait dengan pekerjaannya, sebagai bagian dari perencanaan karir berikutnya.
Proses pengembangan diri yang dilakukan merupakan inisiasi/dorongan pribadi (self-driven), penekanannya adalah kemandirian dan tanggung jawab atas pengembangan diri.',
                    'definition_english' => 'Kompetensi ini berkembang seiring dengan komitmen dan upaya yang dilakukan untuk mengembangkan kemampuan/kapasitas diri.',
                    'status' => 1,
                ),
                325 => 
...
- Terbuka terhadap kritik',
                ...
                array (
                    ...
                    'name' => 'Networking',
                    'type' => 'TELKOMSEL DIGILIFE',
                    'definition' => '- Membangun hubungan dengan semua stakeholder
- Menjaga hubungan untuk menciptakan nilai tambah bagi perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                    'definition' => 'Pengetahuan dan kemampuan dalam merumusakan desain rancang bangun pengembangan solusi IT, baik hardware, software, platform, maupun komponen IT lainnya, berdasarkan pada prinsip-prinsip, metode, standar, serta pedoman penyusunan yang berlaku, dengan memperhatikan keselarasannya pada arsitektur IT perusahaan, guna mendukung pemenuhan target pengembangan solusi IT secara akurat dan tepat guna',
                    'definition_english' => '',
                    'status' => 1,
                ),
                339 => 
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam menentukan kebutuhan spesifikasi serta kapasitas infrastruktur IT, baik hardware, software, maupun infrastruktur lainnya (e.g., hard disk storage, computing power, software & network resources, dll.), dengan melakukan perhitungan, analisis, serta memastikan keselarasannya dengan requirement document yang telah disepakati, didasarkan pada prinsip & framework IT Capacity Planning, guna mendukung penyediaan infrastruktur yang optimal dan selaras dengan kebutuhan perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                341 => 
                ...
                array (
                    ...
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman tentang konsep dasar, metodologi, ruang lingkup, tahapan detail pelaksanaan, serta teknik/tools, untuk merancang, memonitor, mengevaluasi, serta meningkatkan efektivitas dan efisiensi setiap tahapan proyek berbasis agile',
                    'definition_english' => '',
                    'status' => 1,
                ),
                344 => 
                array (
                    'id' => 352,
                    'name' => 'Revenue Assurance Fundamentals',
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman tentang konsep umum serta prinsip-prinsip inti dalam mendeteksi, menyelidiki, mengoreksi, dan mencegah kebocoran pendapatan dan biaya yang dapat berdampak langsung pada bottom line bisnis perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                345 => 
                array (
                    ...
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman terhadap desain, konsep, struktur, roadmap, strategi jangka panjang, arahan, serta proses terkait tata kelola data perusahaan yang tepat dan menyeluruh bagi keberlangsungan bisnis perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                346 => 
                array (
                    ...
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman terhadap konsep, jenis, kebutuhan, model, formula, serta tata cara penyusunan suatu algoritma atau kode pemrograman yang terintegrasi, akurat, dan tepat guna',
                    'definition_english' => '',
                    'status' => 1,
                ),
                347 => 
                array (
                    ...
                    'type' => 'KNOWLEDGE',
                'definition' => 'Pengetahuan dan pemahaman tentang prinsip, sistem, pelayanan, serta end-to-end billing process (e.g., roaming, interconnection, TAP, prepaid, postpaid, dll.), termasuk proses mediasi, rating, tarif, manajemen akses, manajemen issue, negosiasi, settlement, serta penanganan complain handling dari pelanggan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                348 => 
                array (
                    'id' => 356,
                    'name' => 'Human-Computer Interaction Fundamentals',
                    'type' => 'KNOWLEDGE',
                'definition' => 'Pengetahuan dan pemahaman terhadap konsep interdisiplin yang berfokus pada aspek komunikasi dan/atau interaksi antar manusia (sebagai pengguna) dengan komputer, mencakup di dalamnya pengenalan serta pembahasan mengenai Information Architecture, User Interface, User Experience, hingga manajemen konten dalam suatu produk digital',
                    'definition_english' => '',
                    'status' => 1,
                ),
                349 => 
                array (
                    ...
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman menyeluruh terkait prosedur dan sistem administrasi dokumen serta administrasi operasional, termasuk surat menyurat, pengarsipan, pengorganisasian, penggandaan, pemusnahan, dan kegiatan administrasi lainnya yang mendukung kegiatan bisnis perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                350 => 
                array (
                    ...
                    'name' => 'Land Documents',
                    'type' => 'KNOWLEDGE',
                'definition' => 'Pengetahuan dan pemahaman tentang proses pengelolaan pertanahan yang meliputi proses identifikasi, penelitian dan pengumpulan dokumen tanah (atas hak) dalam rangka peningkatan hak atas tanah',
                    'definition_english' => '',
                    'status' => 1,
                ),
                351 => 
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam melakukan identifikasi & penilaian calon partner potensial (berdasarkan analisis kesempatan yang dilakukan), menyusun strategi, serta menerapkan teknik pembinaan hubungan (melalui proses negosiasi) sehingga tercapai kesepakatan kerjasama bisnis dengan para pemangku kepentingan (e.g., Kerjasama Marketing, Joint Venture, Equity Strategic Alliance, dll.), guna mendukung terciptanya progress, opsi-opsi terbaik untuk mencapai tujuan maupun menyelesaikan masalah bisnis perusahaan dan meningkatkan kesempatan pengembangan kapabilitas perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                352 => 
                ...
                array (
                    ...
                    'type' => 'TECHNICAL SKILL',
                'definition' => 'Pengetahuan dan kemampuan dalam melakukan identifikasi, kajian, evaluasi, analisis kelayakan peluang, hingga merumuskan rencana/ide optimasi bisnis digital (e.g., pemanfaatan space pada e-Commerce Platform, dll.), dengan mempertimbangkan perkembangan tren pemanfaatan bisnis digital maupun preferensi perilaku pelanggan, dalam rangka menjadikan bisnis digital tersebut sebagai enabler yang mampu memberikan nilai tambah bagi peningkatan revenue/laba perusahaan, memenuhi kebutuhan, serta mendukung terciptanya experience positif bagi pelanggan, termasuk menghasilkan rekomendasi/masukan bagi strategi marketing perusahaan',
                    'definition_english' => '',
                    'status' => 1,
                ),
                354 => 
                ...
                array (
                    'id' => 365,
                    'name' => 'Marketing Technology Fundamentals',
                    'type' => 'KNOWLEDGE',
                    'definition' => 'Pengetahuan dan pemahaman terkait dengan pemanfaatan teknologi dalam kegiatan marketing',
                    'definition_english' => '',
                    'status' => 1,
                ),
            ));
